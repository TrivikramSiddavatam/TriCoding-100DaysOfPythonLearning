#Higher Lower Game - Replit Files
#main.py
...
def Format_data (account):
  """Format the account data into a printabla account"""
...
while Game_Continue:
  # Ganerate random account
  #making accounts at position B becomes the next account at position A
  account_a = account_b
  account_b = random.choice(data)
